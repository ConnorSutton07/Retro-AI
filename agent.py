...
class DQNAgent:
    def __init__(self,
        ...
        if self.double_dq:
            ...
            self.copy = 5000 # copy model weights into target network after every 5,000 steps
            self.step = 0
        else:
        ...
        if self.pretrained:
            ...
            with open("num_in_queue.pkl", 'rb') as f:
                self.num_in_queue = pickel.load(f)
    ...
    def remember(self, state, action, reward, state2, done: bool) -> None:
    ...
    def experience_replay(self):
        ...
        loss.backword() # Compute gradients
